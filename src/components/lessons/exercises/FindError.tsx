...
export function FindErrorView({
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="flex flex-wrap gap-x-1.5 gap-y-2 rounded-xl border border-mist bg-white px-4 py-4 text-[17px] leading-relaxed text-slate">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                !checked && "hover:bg-navy/10 active:scale-95",
                !checked &&
                  selected &&
                  "bg-navy/15 font-bold text-navy underline decoration-yellow decoration-2 underline-offset-4",
                checked && isTheError && "bg-success/15 font-bold text-navy",
                checked && selected && !isTheError && "bg-error/15 text-navy line-through",
